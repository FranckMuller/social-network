...
import { DialogsState, DialogsActions } from './types';
...
const dialogsReducer = (state = initialState, action: DialogsActions): DialogsState => {
  switch (action.type) {
    case CHANGE_NEW_MESSAGE_TEXT:
      return {
        ...state,
        newMessageText: action.payload.value,
      };
